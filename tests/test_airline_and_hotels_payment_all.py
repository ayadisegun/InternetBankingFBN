...
class TestAirlineAndHotels:
    ...
    def test_airline_and_hotel_payment(self):
        # Verify access
        ...
        for merchant in self.bills_payment.airlines_and_hotel_options:
            ...
            with allure.step(f"Processing merchant → {merchant}"):
                ...
                # Re-navigation
                self.dashboard.click_airtime_and_data_option()
                self.dashboard.click_buy_data_option()
                self.dashboard.click_bills_payment_option()
